      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#409891] to-[#48ADB7] p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h2 className="text-4xl font-bold text-white mb-4">
            Start Your<br />Learning Adventure
          </h2>
          <p className="text-white/90 text-lg">
            Join thousands of learners mastering new skills and achieving their career goals.
          </p>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            ...
            <div className="mt-6 text-center">
              <p className="text-gray-600">
                ...
                <a href="/login" className="text-[#409891] hover:text-[#48ADB7] font-semibold">
                  Sign in
                </a>
              </p>
            </div>
